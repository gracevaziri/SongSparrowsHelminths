...
"AH = Y if a bird was treated with anthelmintic drugs, N if a bird was given water control"
"LPS = Y if a bird injected with LPS, N if no injection"
...
parasite_egg_ever = whether parasite eggs were ever detected in a bird's feces